'''
Webcam_HSV_Less reads the image from the camera then looks for circles on every 5th frame. 
The frame frequency is set on line 39: frame_num.
...
'center_points'                 The data is the center points at every 5th frame
'center_points_formatted'       the data is formatted to CSV data (color,(x,y),color1,(x1,y1) etc.)
'center_points_less_frames'     is not currently implemented
